...
See the [slack-coworker example](https://github.com/ai-employee-sdk/ai-employee/tree/main/examples/slack-coworker) for a complete implementation of this pattern.
